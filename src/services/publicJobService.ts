...
export function transformPublicJobToPosting(raw: PublicJobRaw): JobPosting | null {
  ...
  return {
    ...
    matchingSignals: ['공공기관 공식 공고', categoryName, location],
    recommendedTalentType: `${categoryName} 전문 공공 프로젝트 인재`,
    matchingScoreCriteria: ['직무 연관성', '공공기관 경험', '근무지 적합도'],
    interviewFocus: ['직무 수행 능력 및 성과', '공공 윤리 및 협업 태도'],
    seniorFitScore: 94,
    postedAt: registeredAt,
    source: 'public',
    sourceUrl,
    sourceProvider: '공공기관 채용정보 Open API (잡알리오 / 공공데이터포털)',
