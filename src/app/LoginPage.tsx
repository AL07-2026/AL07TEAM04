...
export function RollingBanner({ isCompact = false }: { isCompact?: boolean }) {
  ...
  return (
    <div className="flex flex-col gap-2 w-full">
      ...
      <div className="ui-banner-frame relative w-full overflow-hidden rounded-2xl border border-[#E0D9C8] bg-[#FAF7F2] shadow-2xs group">
        <img
          src={slide.image}
          alt={slide.title}
        ...
        <button
          ...
          className="ui-icon-button absolute left-3 top-1/2 -translate-y-1/2 flex rounded-full bg-white/90 text-[#17212B] shadow-md border border-[#E0D9C8] hover:bg-white transition"
        >
        ...
        <button
          ...
          className="ui-icon-button absolute right-3 top-1/2 -translate-y-1/2 flex rounded-full bg-white/90 text-[#17212B] shadow-md border border-[#E0D9C8] hover:bg-white transition"
        >
        ...
        <div className="flex flex-col gap-4 w-full max-w-sm mx-auto my-auto py-2">
          ...
          <div className="flex w-full rounded-full border border-[#E0D9C8] bg-white p-1 shadow-2xs">
            <button
              ...
              className={cn(
                'ui-segment-button flex flex-1 items-center justify-center gap-1.5 rounded-full font-extrabold transition-all',
                role === 'senior'
          ...
          <form className="flex flex-col gap-3 pt-0.5" onSubmit={submit}>
            <div className="flex flex-col gap-1 text-left">
              <label className="ui-field-label font-extrabold text-[#17212B]">이메일</label>
              <input
                autoComplete="email"
                type="email"
                required
                ...
                className="ui-field w-full rounded-xl border border-[#E0D9C8] bg-white px-4 font-medium text-[#17212B] outline-none focus:border-[#F06B4F] focus:ring-2 focus:ring-[#F06B4F]/15"
              />
            </div>

            <div className="flex flex-col gap-1 text-left">
              <label className="ui-field-label font-extrabold text-[#17212B]">비밀번호</label>
              <input
            ...
            <button
              ...
              className="ui-action-button flex w-full items-center justify-center rounded-full bg-[#173F3A] font-extrabold text-white shadow-xs transition-all hover:bg-[#0E2825] active:scale-[0.99] disabled:opacity-40"
            >
              {isSubmitting
                ? '로그인 처리 중...'
                : role === 'senior'
            ...
            <div className="relative my-0.5 flex items-center justify-center">
              ...
              <span className="relative bg-[#F7F3EA] px-2.5 text-[11px] font-bold text-slate-400">
                간편 로그인
              </span>
            </div>
            ...
            <button
              ...
              disabled={isSubmitting}
              className="ui-secondary-button flex w-full items-center justify-center gap-2 rounded-full border border-[#E0D9C8] bg-white font-extrabold text-[#17212B] shadow-2xs transition-all hover:bg-[#FAF7F2] active:scale-[0.99]"
            >
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8 lg:gap-12 items-center max-w-5xl w-full mx-auto my-auto py-4 md:py-6">
        ...
        <div className="md:col-span-7 flex flex-col justify-center gap-5 py-2">
          <div className="flex flex-col gap-2.5 items-start text-left">
            ...
            <p className="ui-body-text max-w-xl">
              {role === 'senior'
                ? '자신의 경험으로 기업의 문제를 해결할 수 있도록 AI 경험 인터뷰로 매칭합니다.'
                : '필요한 전문 프로젝트를 경험 카드로 검증된 인재에게 즉시 제안해보세요.'}
            </p>
        ...
        <div className="md:col-span-5 flex flex-col gap-4 rounded-3xl border border-[#E0D9C8] bg-white p-6 md:p-7 lg:p-8 shadow-lg my-2">
          ...
          <form className="flex flex-col gap-3.5" onSubmit={submit}>
            ...
            <button
              type="submit"
              disabled={isSubmitting}
              className="ui-action-button flex w-full items-center justify-center rounded-full bg-[#173F3A] font-extrabold text-white shadow-xs transition-all hover:bg-[#0E2825] active:scale-[0.995] disabled:opacity-40"
            >
              {isSubmitting
                ? '로그인 처리 중...'
                : role === 'senior'
            ...
            <button
              ...
              onClick={() => void handleGoogleSignIn()}
              disabled={isSubmitting}
              className="ui-secondary-button flex w-full items-center justify-center gap-2 rounded-full border border-[#E0D9C8] bg-white font-extrabold text-[#17212B] shadow-2xs transition-all hover:bg-[#FAF7F2] hover:border-[#173F3A] active:scale-[0.992]"
            >
              <svg className="size-4.5 shrink-0" viewBox="0 0 24 24">
                <path
                  fill="#4285F4"
