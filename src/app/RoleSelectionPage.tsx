            ...
            >
              <span className="flex items-center justify-between gap-3">
                <span className="flex items-center gap-2.5">
                  ...
                  >
                    <RoleIcon aria-hidden="true" className="size-5" strokeWidth={2.25} />
                  </span>
                  <strong className="text-base font-extrabold text-[#17212B]">{role.title}</strong>
                </span>
                <span
                  className={cn(
                    'inline-flex items-center gap-1 text-xs font-extrabold px-3 py-1 rounded-full transition-colors',
                    selected === role.id
