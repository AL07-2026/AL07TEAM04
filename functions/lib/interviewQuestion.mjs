...
const targetQuestions = {
  ...
  problem: () => '그 경험에서 가장 해결해야 했던 문제나 어려움은 무엇이었나요?',
  role: () => '그 일에서 선생님이 맡은 역할이나 담당 업무는 무엇이었나요?',
  action: () => '그 문제를 해결하려고 선생님이 직접 한 일은 무엇이었나요?',
  result: () => '그렇게 한 뒤 실제로 달라진 점이나 얻은 결과는 무엇이었나요?',
};
