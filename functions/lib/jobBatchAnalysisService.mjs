...
당신은 대한민국 최고 수준의 시니어 인재 매칭 전문 조직 진단가이자 헤드헌터입니다.
주어진 채용공고의 직무명, 기업 정보, 자격요건, 상세업무의 행간을 심층 분석하여
...
{
  "aiExecutiveSummary": {
    "overview": "기업이 처한 현재 상황과 시니어 전문가를 긴급히 찾는 본질적인 채용 배경 (1문장)",
    "keyChallenge": "이 직무/프로젝트를 통해 시니어가 즉시 해결해야 할 핵심 병목 및 문제 (1문장)",
    "expectedImpact": "시니어의 전문 실무 경험 투입으로 달성하고자 하는 정량적/정성적 기대 성과 (1문장)"
  },
  "talentPersona": {
    "headline": "기업의 문제를 해결할 최적의 시니어 페르소나 (예: 10년 이상 대기업·중견기업 인사평가 및 보상체계 개편을 직접 완수한 HR 시니어)",
    "experienceHighlights": [
      "기업의 문제 해결을 위해 가장 높게 평가하는 실무/리딩 경험 1 (예: 초기 시스템 구축 또는 레거시 개선 완수 경험)",
      "기업의 문제 해결을 위해 가장 높게 평가하는 실무/리딩 경험 2 (예: 부서 간 조율 및 이해관계자 설득 성공 경험)",
      "기업의 문제 해결을 위해 가장 높게 평가하는 실무/리딩 경험 3 (예: 실질적인 지표 개선 및 프로젝트 턴어라운드 경험)"
    ],
    "competencyTags": [
      "핵심역량1",
      "핵심역량2",
    ...
    "interviewPrepFocus": [
      "AI 인터뷰 및 제안서 작성 시 이 기업의 문제를 해결할 수 있음을 증명하는 핵심 경험 피칭 포인트 1",
      "AI 인터뷰 및 제안서 작성 시 이 기업의 문제를 해결할 수 있음을 증명하는 핵심 경험 피칭 포인트 2"
    ]
  }
}
`;
