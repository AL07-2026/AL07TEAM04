  ...
  return JSON.stringify(
    {
      ...
      instruction:
        '다음 질문을 생성하거나 인터뷰 완료 여부를 판단해 주세요. history가 비어 있으면 어려웠던 문제를 묻지 말고 선택 분야에서 자신 있는 일이나 잘하는 일을 먼저 물어보세요. question은 complete가 false일 때만 짧은 한국어 질문으로 작성하세요. 이전 질문과 같은 의미의 질문은 절대 반복하지 마세요. serverDetectedCollected가 true인 항목은 이미 말한 정보로 보고 target으로 다시 선택하지 마세요.',
    },
    null,
    2,
  );
